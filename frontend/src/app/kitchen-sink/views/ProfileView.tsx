    ...
    <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
      <div className="md:col-span-4 flex flex-col gap-6">
        <div className="rounded-2xl border border-border bg-card p-6 shadow-sm flex flex-col items-center text-center relative overflow-hidden">
          ...
          <p className="text-sm text-muted-foreground mt-1 tracking-widest uppercase">Expires 2031</p>
      ...
      <div className="md:col-span-8 flex flex-col gap-8">
        <div>
          <h3 className="font-display font-bold text-2xl mb-4 flex items-center gap-2">
            <Award className="w-6 h-6 text-lacquer" /> Linked Loyalty Programs
          </h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="rounded-xl border border-border bg-card p-5 hover:border-border/80 transition-colors">
              <div className="flex justify-between items-center mb-4">
                ...
                <span className="text-xs font-bold text-lacquer bg-lacquer/10 px-2 py-1 rounded">Silver Medallion</span>
              </div>
              <p className="text-2xl font-display font-bold text-foreground">42,500</p>
              <p className="text-xs text-muted-foreground mt-1">Miles available</p>
            </div>
            <div className="rounded-xl border border-border bg-card p-5 hover:border-border/80 transition-colors">
              <div className="flex justify-between items-center mb-4">
              ...
              <p className="text-2xl font-display font-bold text-foreground">118,000</p>
        ...
        <div>
          ...
          <div className="rounded-2xl border border-border bg-card overflow-hidden">
            <div className="p-4 border-b border-border/50 flex justify-between items-center">
              <span className="font-medium text-foreground">Home Airport</span>
              <span className="text-sm text-muted-foreground font-bold tracking-widest">JFK, LGA, EWR</span>
            </div>
            <div className="p-4 border-b border-border/50 flex justify-between items-center">
              <span className="font-medium text-foreground">Seating Preference</span>
              <span className="text-sm text-muted-foreground">Aisle • Forward Cabin</span>
            </div>
            <div className="p-4 flex justify-between items-center">
              <span className="font-medium text-foreground">Dietary Requirements</span>
