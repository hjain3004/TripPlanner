 ...
 * Plan
 */
export const planPlanPost = <ThrowOnError extends boolean = false>(options: Options<PlanPlanPostData, ThrowOnError>): RequestResult<PlanPlanPostResponses, PlanPlanPostErrors, ThrowOnError> => (options.client ?? client).post<PlanPlanPostResponses, PlanPlanPostErrors, ThrowOnError>({
    url: '/plan',
    ...options,
    headers: {
