...
export const MonumentIllustration = ({ type }: { type: 'mtFuji' | 'temple' | 'tower' | 'synergy' | 'passport' }) => {
  ...
  if (type === 'temple') {
    return (
      <svg className="w-full h-56 bg-secondary/30" viewBox="0 0 400 220" fill="none" xmlns="http://www.w3.org/2000/svg">
        <motion.path initial={{ opacity: 0 }} animate={{ opacity: 0.15 }} transition={drawTransition(0)} d="M 0 220 Q 30 160 60 220 M 340 220 Q 370 150 400 220" fill="var(--color-primary)" />
        <motion.path initial={{ opacity: 0 }} animate={{ opacity: 0.7 }} transition={drawTransition(0.1)} d="M 90 220 L 110 170 L 290 170 L 310 220 Z" fill="var(--color-primary)" />
        <motion.rect initial={{ opacity: 0 }} animate={{ opacity: 0.9 }} transition={drawTransition(0.2)} x="130" y="150" width="140" height="20" fill="var(--color-primary)" />
        ...
        <motion.path initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={drawTransition(0.5)} d="M 100 95 Q 200 65 300 95 L 270 80 L 130 80 Z" fill="var(--color-lacquer)" />
        <motion.path initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={drawTransition(0.6)} d="M 115 50 Q 200 20 285 50 L 255 35 L 145 35 Z" fill="var(--color-lacquer)" />
        <motion.circle initial={{ opacity: 0 }} animate={{ opacity: 0.7 }} transition={drawTransition(0.8)} cx="320" cy="60" r="30" fill="var(--color-lacquer)" />
        <motion.rect initial={{ opacity: 0 }} animate={{ opacity: 0.9 }} transition={drawTransition(0.9)} x="140" y="95" width="120" height="40" fill="var(--color-background)" />
        <motion.rect initial={{ opacity: 0 }} animate={{ opacity: 0.9 }} transition={drawTransition(0.9)} x="155" y="50" width="90" height="30" fill="var(--color-background)" />
        <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={drawTransition(1.1)}>
          ...
          <rect x="110" y="160" width="12" height="18" fill="var(--color-lacquer)" />
          <rect x="278" y="160" width="12" height="18" fill="var(--color-lacquer)" />
        </motion.g>
      </svg>
    );
  }
  ...
  if (type === 'synergy') {
    return (
      <svg className="w-full h-32 bg-secondary/30" viewBox="0 0 400 120" fill="none" xmlns="http://www.w3.org/2000/svg">
        <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={drawTransition(0)}>
          <rect x="80" y="20" width="120" height="80" fill="var(--color-primary)" opacity="0.8" transform="rotate(-15 140 60)" />
        </motion.g>
        <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={drawTransition(0.2)}>
          <rect x="180" y="20" width="120" height="80" fill="var(--color-lacquer)" opacity="0.8" transform="rotate(15 240 60)" />
        </motion.g>
  ...
  if (type === 'passport') {
    return (
      <svg className="w-24 h-32" viewBox="0 0 100 140" fill="none" xmlns="http://www.w3.org/2000/svg">
        <motion.rect initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={drawTransition(0)} x="10" y="10" width="80" height="120" fill="var(--color-primary)" />
