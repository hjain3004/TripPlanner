...
- **Frontend is paused. The Figma bundle in design/ is the visual template. Implementation plan is 2026-07-28-figma-template-reconciliation.md:** implement specs 10 and 11 (frontend tokens + primitives). Do not begin provider gateway, crawling, provider APIs, or MCP/provider work in the same change.
