...
def test_compose_strategy_uses_ortools_then_falls_back():
    ...
    # ComposeStrategy should return the ORTools output if valid.
    # If we make it invalid or timeout, it returns greedy.
    # We will test that calling compose() on the strategy returns a ComposerResult
    # that matches what greedy would return if ORTools failed,
