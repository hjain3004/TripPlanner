...
def _matrix() -> RouteMatrix:
    return RouteMatrix(cells=[
        RouteCell(origin_place_id="p1", destination_place_id="p2", mode="transit", duration_min=15, distance_km=1, retrieved_at=datetime.now(UTC), source="geodesic_estimate", status="estimated", confidence=0.9),
        RouteCell(origin_place_id="p2", destination_place_id="p3", mode="transit", duration_min=20, distance_km=1.5, retrieved_at=datetime.now(UTC), source="geodesic_estimate", status="estimated", confidence=0.9),
        RouteCell(origin_place_id="p1", destination_place_id="p3", mode="transit", duration_min=30, distance_km=2, retrieved_at=datetime.now(UTC), source="geodesic_estimate", status="estimated", confidence=0.9)
    ])
