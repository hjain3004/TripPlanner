    ...
    def compose(
        ...
        try:
            ...
            if validation.valid:
                ...
                logger.warning(
                    f"ORTools produced invalid itinerary. Rejections: "
                    f"{validation.rejections}. Falling back to greedy."
                )
        except Exception as e:
            logger.warning(
                f"ORTools composition failed with exception: {e}. Falling back to greedy."
            )
